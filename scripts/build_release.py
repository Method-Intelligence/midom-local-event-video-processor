...
def write_quickstart(stage_dir: Path, build: FfmpegBuild) -> None:
    (stage_dir / "QUICKSTART.txt").write_text(
        ...
        "Stopping:\n"
        "  Type Q and press Enter to stop for now and keep the saved pairing.\n"
        "  Type T and press Enter only when you want to disconnect this computer from Midom.\n"
        "  Disconnecting removes the saved pairing and requires a new pairing code next time.\n\n"
        "Windows:\n"
